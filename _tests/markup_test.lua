...
assert(gui.elements[1].id     == false,         output("false",  gui.elements[1].id))
...
assert(gui.elements[3].id     == false,         output("false",  gui.elements[3].id))
assert(softcompare(gui.elements[3].value, 3),   output("3",      gui.elements[3].value))
assert(gui.elements[4].id     == false,         output("false",  gui.elements[4].id))
...
assert(gui.elements[7].id     == false,         output("false",  gui.elements[7].id))
assert(gui.elements[7].value  == ">>1",         output(">>1",    gui.elements[7].value))
assert(gui.elements[8].id     == false,         output("false",  gui.elements[8].id))
assert(gui.elements[8].value  == ">>2",         output(">>2",    gui.elements[8].value))
assert(gui.elements[9].id     == false,         output("false",  gui.elements[9].id))
assert(gui.elements[9].value  == ">>3",         output(">>3",    gui.elements[9].value))
assert(gui.elements[10].id    == false,         output("false",  gui.elements[10].id))
assert(gui.elements[10].value == ">2",          output(">2",     gui.elements[10].value))
assert(gui.elements[11].id    == false,         output("false",  gui.elements[11].id))
assert(softcompare(gui.elements[11].value, 6),  output("6",      gui.elements[11].value))
assert(gui.elements[12].id    == false,         output("false",  gui.elements[12].id))
assert(gui.elements[12].value == "seven",       output("seven",  gui.elements[12].value))
assert(gui.elements[13].id    == false,         output("false",  gui.elements[13].id))
assert(softcompare(gui.elements[13].value, 8),  output("8",      gui.elements[13].value))
assert(gui.elements[14].id    == false,         output("false",  gui.elements[14].id))
assert(softcompare(gui.elements[14].value, 9),  output("9",      gui.elements[14].value))
assert(gui.elements[15].id    == false,         output("false",  gui.elements[15].id))
